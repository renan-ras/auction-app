...
describe 'Lotes (em andamento e) futuros' do
  context 'por visitante' do
    ...
    it 'e em detalhes' do
      ...
      lot_b = Lot.create!(code: 'ABC123456', start_date: start_date_b = 1.hour.from_now,
                          end_date: end_date_b = 3.days.from_now, minimum_bid: 100, minimum_bid_increment: 10, creator: admin_a)
      item_c.update(lot_id: lot_b.id) # Item C adicionado ao Lote B
