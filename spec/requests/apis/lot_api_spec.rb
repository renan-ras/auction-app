...
describe 'Lot API' do
  context 'GET /api/v1/lots/1' do
    it 'success' do
      ...
      admin_b = User.create!(nickname: 'Pele', email: 'rei@leilaodogalpao.com.br', password: '123456',
                             cpf: '15703243017')
      lot_a = Lot.create!(code: 'XYZ123456', start_date: Time.now + 1.day, end_date: Time.now + 7.days,
                          minimum_bid: 100.0, minimum_bid_increment: 10.0, creator: admin_a)
      item_a = Item.create!(lot_id: lot_a.id, name: 'Moto G', description: '16GB RAM 512GB HD', weight: '200',
                            width: '5', height: '16', depth: '2', category: 'Eletrônicos')
  ...
  context 'GET /api/v1/lots' do
    it 'in code order' do
      ...
      lot_b = Lot.create!(code: 'ABC123456', start_date: 1.day.from_now, end_date: 3.days.from_now, minimum_bid: 100,
                          minimum_bid_increment: 10, creator: admin_a)
      item_b = Item.create!(lot_id: lot_b.id, name: 'Suporte de Celular', description: 'material plástico ABS',
                            weight: '50', width: '6', height: '10', depth: '5', category: 'Acessórios')
  ...
  context 'POST /api/v1/lots' do
    it 'success' do
      ...
      admin_a = User.create!(nickname: 'Ronaldo', email: 'fenomeno@leilaodogalpao.com.br', password: '123456',
                             cpf: '69142235219')
      lot_params = { lot: { code: 'XYZ123456', start_date: 1.day.from_now, end_date: 3.days.from_now, minimum_bid: 100,
                            minimum_bid_increment: 10, creator_id: admin_a.id } }
